    ...
    return (
        <div className={classes.container}>
            ...
            <div className={classes.rightContent}>
                <span onClick={()=>setVisible(true)} className={classes.addVisit}>
            ...
            <MyModal visible={visible} setVisible={setVisible}>
                <div className={classes.modalContent}>
                    ...
                    <svg width="54" height="54" viewBox="0 0 54 54" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect width="54" height="54" rx="3" fill="#CDDCED"/>
                    </svg>
                    <span style={{paddingLeft:"26px"}} className={classes.dropDownText}>Ім'я Прізвище пацієнта</span>
                    </div>

                    <span style={{paddingTop:"33px"}} className={classes.RobotoGrey}>Адерса:</span>
                        <span  style={{paddingTop:"2px"}}  className={classes.dropDownText}>Київ, вул Калачівська, 13(Стара Дарниця)</span>
                    <span style={{paddingTop:"33px"}} className={classes.RobotoGrey}>Лікар:</span>
                    <span  style={{paddingTop:"2px"}}  className={classes.dropDownText}>Ім'я Прізвище</span>

                    <span style={{paddingTop:"42px"}} className={classes.Roboto20}>16 лютого 2024</span>
                    <span  style={{paddingTop:"6px"}}  className={classes.Roboto20}>10:30 - 11:00</span>
                    <div style={{paddingTop:"59px", display:"flex", justifyContent:"end"}}>
                    <AnswerButton >Підтвердити</AnswerButton>
                    </div>
                </div>
            </MyModal>
        </div>
