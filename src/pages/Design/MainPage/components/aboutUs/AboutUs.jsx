...
const AboutUs = () => {
    const mockedItems = [
        {    id: 1,
            description: "Співробітники завжди зустрічають з посмішкою, вникають у прохання вирішити проблеми протезування клієнтів, ремонту протезів, забезпечення чохлами, силіконовими лайнерами, та іншим без зайвої тяганини. Дуже вдячна усім працівникам та окремо Олексію Ковальчуку! Успіхів Вам у Вашій благородній справі!",
